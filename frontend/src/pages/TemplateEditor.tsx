            ...
            {activeTab === 'ai' && (
              <div className="h-full">
                <TemplateChat
                  ...
                  systemPrompt="You are a report template generation expert for security assessments. Help users create and modify report templates using the custom template syntax with {{variable}}, {{#each}}, and {{#if}} directives."
                />
              </div>
            )}
          </div>
