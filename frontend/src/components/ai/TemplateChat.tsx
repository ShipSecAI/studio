        ...
        {isLoading && messages[messages.length - 1]?.role === 'user' && (
          <div className="flex flex-col gap-3 pl-9 animate-in fade-in duration-500">
            <div className="flex gap-1.5 items-center">
              <div className="w-1.5 h-1.5 bg-purple-500/40 rounded-full animate-bounce [animation-delay:-0.3s]" />
              <div className="w-1.5 h-1.5 bg-purple-500/40 rounded-full animate-bounce [animation-delay:-0.15s]" />
              <div className="w-1.5 h-1.5 bg-purple-500/40 rounded-full animate-bounce" />
              <span className="text-[10px] text-muted-foreground/50 ml-1 font-medium italic">Processing...</span>
            </div>
          </div>
        )}
